#############################################################################
#Create a wiggler like magnetic structure. Calculate !two! electric field files 
#otimised for extracting spectrum and intensity. Draw it and save it to files using pickle lib
#v0.1
#############################################################################
...
wfr1FileName = 'wfr1_for_wiggler.wfr' #file name for output UR flux data
wfr2FileName = 'wfr2_for_wiggler.wfr'
#***********Undulator
undarr = []
undarrH = []
distz =  []
