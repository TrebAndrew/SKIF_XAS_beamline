...
plt.tight_layout()
plt.savefig(SKIF_path + FigPath + 'power_dens_1-1.pdf')#, bbox_inches='tight')
...
plt.tight_layout()
plt.show()
plt.savefig(SKIF_path + FigPath + 'power_dens_1-1_2d.pdf')#, bbox_inches='tight')
...
plt.tight_layout()
plt.show()
plt.savefig(SKIF_path + FigPath + 'Spec_1-1.pdf')#, bbox_inches='tight')
