...
A = 1e6/wfr2.mesh.zStart #scaling facor for the transferring xy distribution from [m] to [rad] 

skf.skf_wfr_subplot_XY(wfr2, save_fig=True, figure_name='11_harm_befour_crystal', fourth_plot=0) #function to draw xy distribution
#skf.skf_wfr_subplot_XY(wfr3, save_fig=True, figure_name='13_harm_befour_crystal', fourth_plot=0) #function to draw xy distribution
#skf.skf_wfr_subplot_XY(wfr4, save_fig=True, figure_name='17_harm_befour_crystal', fourth_plot=0) #function to draw xy distribution
#skf.skf_wfr_subplot_XY(wfr5, save_fig=True, figure_name='23_harm_befour_crystal', fourth_plot=0) #function to draw xy distribution

sigma_x, sigma_y = skf.calc_bandwidth(wfr2) #calculates sigma fot the electric field distribution 
print('sigma_x_11 = ', round(sigma_x,3),'[urad] \t','sigma_y_11 = ', round(sigma_y,3),'[urad]')

#%%
#skf.skf_plot_spec(wfr1) #function to draw spectrum
#skf.skf_plot_spec(wfr6) #function to draw spectrum
#%%
...
#srwl.CalcIntFromElecField(arI1, wfr6, 6, 0, 0, wfr1.mesh.eStart, wfr1.mesh.xStart, wfr1.mesh.yStart)
...
skf.skf_plot(E, spec, elec_fld_units='W/mm^2/eV', color='blue', grid=True, linewidth=1.5)

E2, full_spec = skf.renorm_wfr(wfr6, elec_fld_units='W/mm^2/eV')
skf.skf_plot(E2, full_spec, color='pink', elec_fld_units='W/mm^2/eV', grid=True, linewidth=1)
...
skf.skf_plot(E, spec*(T**2)*(z1/(z1+1))**2, color='blue', elec_fld_units='W/mm^2/eV', grid=True, linewidth=2)
W1 = (np.sum(spec*T*(z1/(z1+1))**2) - np.sum(spec*T**2*(z1/(z1+1))**2))*((wfr1.mesh.eFin - wfr1.mesh.eStart) / wfr1.mesh.ne)

skf.skf_plot(E, spec*(T**3)*(z1/(z1+2))**2, color='red', elec_fld_units='W/mm^2/eV', grid=True, linewidth=2)
W2 = (np.sum(spec*(T**2)*(z1/(z1+2))**2) - np.sum(spec*(T**3)*(z1/(z1+2))**2))*((wfr1.mesh.eFin - wfr1.mesh.eStart) / wfr1.mesh.ne)

skf.skf_plot(E, spec*(T**4)*(z1/(z1+3))**2, color='blue', elec_fld_units='W/mm^2/eV', grid=True, linewidth=2)
W3 = (np.sum(spec*(T**3)*(z1/(z1+3))**2) - np.sum(spec*(T**4)*(z1/(z1+3))**2))*((wfr1.mesh.eFin - wfr1.mesh.eStart) / wfr1.mesh.ne)

skf.skf_plot(E, spec*(T**5)*(z1/(z1+4))**2, color='black', elec_fld_units='W/mm^2/eV', grid=True, linewidth=3)
W4 = (np.sum(spec*T**4*(z1/(z1+4))**2) - np.sum(spec*T**5*(z1/(z1+4))**2))*((wfr1.mesh.eFin - wfr1.mesh.eStart) / wfr1.mesh.ne)

full_W = np.sum(full_spec)*((wfr6.mesh.eFin - wfr6.mesh.eStart) / wfr6.mesh.ne)
left_W = (np.sum(spec*T**5*(z1/(z1+4))**2))*((wfr1.mesh.eFin - wfr1.mesh.eStart) / wfr1.mesh.ne)

#E2, full_spec = skf.renorm_wfr(wfr6, elec_fld_units='W/mm^2/eV')
#skf.skf_plot(E2, full_spec, color='pink', elec_fld_units='W/mm^2/eV', grid=True, linewidth=1,sava_figure=True, file_name='spec.png')
...
distance = wfr2.mesh.zStart 
slit = 0.5#4*sigma_x*distance*1e-3 # mm
...
skf.skf_wfr_subplot_XY(wfr2, save_fig=True, figure_name='11_harm_after_crystal', fourth_plot=0)
#skf.skf_wfr_subplot_XY(wfr3, save_fig=True, figure_name='13_harm_after_crystal', fourth_plot=1)
#skf.skf_wfr_subplot_XY(wfr4, save_fig=True, figure_name='17_harm_after_crystal', fourth_plot=1)
#skf.skf_wfr_subplot_XY(wfr5, save_fig=True, figure_name='23_harm_after_crystal', fourth_plot=0)
